...
<head>
<meta charset="UTF-8">
<title>Pregled polazaka letova s jednog aerodroma</title>
</head>
<body>
...
<table border="1">
		...
		<tbody> 
			<%
			java.util.List<LetAviona> letovi = (java.util.List<LetAviona>) request.getAttribute("letoviSJednogAerodroma");
			...
			<tr>
				...
				<td>
				<form method="POST" action="spremiLetove">
